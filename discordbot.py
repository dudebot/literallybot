...
''')
            ...
            #    player.start()
            elif message.content.startswith('!annoydudebot'):
                for i in range(5):
                    api.turn_on("251adae6-6403-4235-9e08-531a4294ab3b")
                    api.turn_off("251adae6-6403-4235-9e08-531a4294ab3b")
                ...
                await message.author.send(file=File(snuggles))
            ...
            #also make a command to update the list of commands from the contents of the folder
                ...
                await message.channel.send(file=File("squish.webm"))
            elif message.content.startswith("!ding"):
                await message.channel.send(file=File("dingdingdoo.webm"))
            elif message.content.startswith("!aaa"):
                await message.channel.send(file=File("aaaaaaaa_hd.mp4"))
            elif message.content.startswith("!nigga"):
                await message.channel.send(file=File("nwordcute.mp4"))
            elif message.content.startswith("!pog"):
                await message.channel.send(file=File("poggers.mp4"))
            elif message.content.startswith("!heyhey"):
                await message.channel.send(file=File("kaguya-sama.mp4"))
            elif message.content.startswith("!based"):
                await message.channel.send(file=File("based.mp4"))
            elif message.content.startswith("!yahallo"):
                await message.channel.send(file=File("yahallo.mp4"))
            elif message.content.startswith("!shrimple"):
                await message.channel.send(file=File("shrimple.mp4"))
            elif message.content.startswith("!hah") or  message.content.startswith("!joneshorn"):
                await message.channel.send(file=File("THE_JONES_LAUGH.mp3"))
            elif message.content.startswith("!hah") or  message.content.startswith("!arbys"):
                await message.channel.send(file=File("arbys.mp4"))
